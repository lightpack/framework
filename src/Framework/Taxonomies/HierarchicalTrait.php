...
/**
 * Provides hierarchical/tree behavior for taxonomy models.
 *
 * Use this trait in any model that needs parent-child tree operations.
 * Works with both plain Model and TenantModel.
 */
