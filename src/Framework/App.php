...
final class App
{
    ...
    {
        return [
            \Lightpack\Logger\LogProvider::class,
            \Lightpack\Routing\RouteProvider::class,
            \Lightpack\Event\EventProvider::class,
            \Lightpack\Cache\CacheProvider::class,
            \Lightpack\Config\ConfigProvider::class,
            \Lightpack\Routing\RouterProvider::class,
            \Lightpack\Filters\FilterProvider::class,
            \Lightpack\Http\CookieProvider::class,
            \Lightpack\Session\SessionProvider::class,
            \Lightpack\Storage\StorageProvider::class,
            \Lightpack\Http\RequestProvider::class,
            \Lightpack\Http\ResponseProvider::class,
            \Lightpack\Database\DatabaseProvider::class,
            \Lightpack\View\TemplateProvider::class,
            \Lightpack\Auth\AuthProvider::class,
            \Lightpack\Utils\CryptoProvider::class,
            \Lightpack\Schedule\ScheduleProvider::class,
            \Lightpack\Validation\ValidationProvider::class,
