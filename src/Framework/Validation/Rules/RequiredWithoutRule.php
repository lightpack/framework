...
class RequiredWithoutRule
{
    ...
    public function __construct(
        ...
        $this->message = "This field is required when {$fieldList} is not present";
        $this->langKey = 'validation.required_without';
    ...
    public function __invoke($value, array $data = []): bool
    {
        ...
        // If at least one field is present, this field is not required
        if ($anyFieldPresent) {
            return true;
        }

        // None of the fields are present, so this field is required
